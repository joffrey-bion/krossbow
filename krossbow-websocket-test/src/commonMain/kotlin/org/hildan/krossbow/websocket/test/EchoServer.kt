...
internal interface TestServer {
     ...
     */
    suspend fun close(code: Int = WebSocketCloseCodes.NORMAL_CLOSURE, message: String? = null)
     ...
     */
    suspend fun closeConnection(code: Int = WebSocketCloseCodes.NO_STATUS_CODE, message: String? = null)
}
